...
(function testInit() {
  ...
  assert(r.ok, "init ok");
  // 308 leaves = 102 native drills + 13 block cadences + 107 inversions
  ...
  // one-accidental pairs + 2 V–i + 2 vii°–i + 4 i–iv–V–i).
  assert(r.exercises === 308, "reports 308 exercise leaves, got " + r.exercises);
