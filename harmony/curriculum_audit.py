...
_CATEGORIES = [
    ...
    ("cadences", "Cadences", ["cat:cadences"],
     ...
     "13 cadences: 6 two-chord types + 7 functional progressions (block)."),
    ...
    ("voice_leading", "Voice Leading", ["cat:voice_leading"],
     ["tests/test_curriculum.py", "tests/test_harmony_lab.py"],
     "13 SATB voice-leading cadences (one per cadence)."),
