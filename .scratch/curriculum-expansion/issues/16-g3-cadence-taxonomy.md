...
- [ ] PAC and IAC exist as distinct leaves with discrimination drills (no more undifferentiated "authentic").
- [ ] The half-cadence family includes approaches from any predominant, including Phrygian iv6–V.
- [ ] The cadential 6/4 lesson + relabel drill ship; the learner can explain why "I6/4" is not tonic here.
- [ ] The cadence catalogue and the cadence-resolution template render the new types automatically; enums stay aligned.
