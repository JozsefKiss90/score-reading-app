# 05 — Scales, keys & the circle of fifths

**What to build:** The explicit gap called out in the wiki brief: the Lab's scale drills assume the student already knows what a scale *is*. After this ticket, a student can read how the major scale is built from whole/half steps, what a key and key signature are, the scale-degree names (tonic…leading tone) behind the Lab's degree drills, the natural minor scale, relative and parallel keys, and how the circle of fifths organises all of it — then jump straight into the referenced drills.
